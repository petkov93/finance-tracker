...
class LandingViewsTests(TestCase):
    ...
    def test_guest_get_root_returns_landing(self):
        ...
        self.assertContains(response, "financetracker/img/landing/hero-380.webp")
        self.assertContains(response, "financetracker/img/landing/dashboard-sm-520.webp")
        self.assertContains(response, "financetracker/img/landing/statistics-sm-520.webp")
        self.assertContains(response, "financetracker/img/landing/converter-sm-520.webp")
        self.assertContains(response, 'rel="preload"')
        self.assertNotContains(response, "fonts.googleapis.com")
        self.assertNotContains(response, "chart.js")
        self.assertNotContains(response, "financetracker/js/money.js")
        self.assertNotContains(response, "financetracker/img/landing/dashboard.jpg")
